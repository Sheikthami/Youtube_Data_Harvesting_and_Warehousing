...
def channel_data(all_id):
    API_KEY = "AIzaSyAyhDpDDKlRV8zBRb74JAGNvVtDxEGseec" #"AIzaSyAyhDpDDKlRV8zBRb74JAGNvVtDxEGseec"
...
def mdb_insert(keyword, channel_Data, video_Data, comments_data):
    ...
    uri = "mongodb+srv://<Name>:<Passcode>@cluster0.w0ka54k.mongodb.net/?retryWrites=true&w=majority"
...
channel_names = ['Amit Thinks', 'Error Makes Clever Academy', 'Gulf Rider', 'Cineulagam Originals', 'martata', 'Tamil Trekker',
                 'MagnatesMedia', 'motivation factory', 'Cherry Vlogs', 'Tranz Moto Hub', 'Others']

channel_ids = ["UCgnr2Lkl1LZf0IOKRDAoJ2g", "UCwr-evhuzGZgDFrq_1pLt_A", "UCMVcxIrKSZczU6-XjIQo6xg",
               "UCIXzVUBy6hAdkxWLvs8Qzxg", "UCXLn61vru9EcfEcPx4t3-IQ", "UCWKAAgM5L7bExQJkPZIbiaw",
               "UCE4Gn00XZbpWvGUfIslT-tA", "UC9nO6ej_Mi1Sd84hGOceNqA", "UCTxfYLmM82aMCovQexkRxFQ",
               "UCoumU_0klXFwfX9bh6H4g0g"]


# page configration ---------------------------------------

icon = Image.open("C:\\Projects\\youtube\\youtube_logo.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By Sheik Abdul Kather",
                   page_icon=icon,
                   layout="wide")
